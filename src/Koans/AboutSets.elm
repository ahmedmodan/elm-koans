...
testSuite =
  suite
    ...
    , test
        ...
        (assertEqualSets (Set.fromList [ 1, 2, 3, 3, 2, 1 ]) (Set.fromList [ 1, 2, 3, 3 ]))
    , test
        "sets may be empty"
    ...
    , test
        ...
        (assertEqualSets (Set.insert 1 oneTwoThree) oneTwoThree)
    , test
    ...
    , test
        ...
        (assertEqualSets (Set.remove 4 oneTwoThree) oneTwoThree)
    , test
